...
class TestDay02(unittest.TestCase):
    ...
    def test_day_02_part_1_short(self):
        self.assertEqual(day_02_part_1(get_input_data('input_02_short.txt')), 8)

    def test_day_02_part_1_full(self):
        self.assertEqual(day_02_part_1(get_input_data('input_02.txt')), 2439)

    def test_day_02_part_2_short(self):
        self.assertEqual(day_02_part_2(get_input_data('input_02_short.txt')), 2286)

    def test_day_02_part_2_full(self):
        self.assertEqual(day_02_part_2(get_input_data('input_02.txt')), 63711)
